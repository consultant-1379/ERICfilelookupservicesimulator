...
function setRstate {
	...
	mv ERICfilelookupservicesimulator/build/feature-release.xml ERICfilelookupservicesimulator/build/feature-release.${rstate}.xml
...
function nexusDeploy {
	...
	ArtifactId=$module
	zipName=ERICfileLookupServiceSimulator
